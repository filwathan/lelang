...
exports.getAllSubCategories = (callback) => {
    const sql = `SELECT "id", "sub_category_code", "sub_category_name", "sub_category_desc", "category_code" FROM "categories_sub" WHERE "is_deleted" = 0 ORDER BY "sub_category_name" ASC`;
    db.query(sql, callback) ;
}
exports.getSubCategoriesByCategoryCode = (categoryCode, callback) => {
    const sql = `SELECT "id", "sub_category_code", "sub_category_name", "sub_category_desc", "category_code" FROM "categories_sub" WHERE "is_deleted" = 0 AND "category_code" = $1 ORDER BY "sub_category_name" ASC`;
